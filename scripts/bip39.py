...
def from_entropy_to_mnemonic(entropy, ENT):
  ...
  entropy_checked = entropy_bytes + checksum[:int(ENT/32)] # devo ancora ragionarci sopra non è così! 
  # perché dovrei prendere i primi ENT/32  bit e non bytes!!!!!
  
  return entropy_checked
...
seed = from_mnemoni_to_seed(mnemonic)
print(seed)

...
def verify_mnemonic(mnemonic, xpub_electrum, version = "standard", passphrase = ''):
...
def my_test_vector_1():
  ...
  version = "standard"
  return verify_mnemonic(mnemonic, xpub_electrum, version)
...
def my_test_vector_3():
  ...
  version = "standard"
  return verify_mnemonic(mnemonic, xpub_electrum, version, passphrase)
